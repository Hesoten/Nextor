...
For Nextor 3 drivers, bits 0 and 2 of the driver flags will always be returned as set. In Nextor 2 a driver could be "drive-based" or "device-based" (in Nextor 3 all drivers are "device-based"), and implementing the DRV_CONFIG routine was optional in Nextor 2 (it's mandatory in Nextor 3).
